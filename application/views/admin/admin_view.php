	<div class="adminprofile">
		...
		<div class="add container">
			<center>
				...
				<form method="post" action="admin/do_register">
					<tr>
						<td>Username: </td>
		...
		<div class="view container ">
			<center>
				<table class="pure-table">
					<tr>
						<td>
							<a href="<?php echo site_url('admin/view_students') ?>" class="pure-menu-link navLink" id="logs">Student Profiles</a>
						</td>
					</tr>
					<tr>
						<td>
							<a href="<?php echo site_url('admin/view_advisers') ?>" class="pure-menu-link navLink" id="add">Adviser Profiles</a>
						</td>
					</tr>
					<tr>
						<td>
		...
		<div class="delete container">
			<center>
				...
				<tr>
					<td>
						<a href="<?php echo site_url('admin/delAdviser') ?>" class="pure-menu-link navLink" id="add">Search a user to delete</a>
					</td>
				</tr>
				</table>
            </center>
